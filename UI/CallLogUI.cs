...
namespace CallLog
{
    public partial class CallLogUI : Form
    {
        ...
        private void SetCompanyName()
        {
            try
            {
                companyName.Items.Add(bll.GetCompanyName(customerCode.Text));
        ...
        private void SetCustomerCode()
        {
            try
            {
                customerCode.Items.Add(bll.GetCustomerCode(contactPhone.Text, contactName.Text));
        ...
        public void PopulateDataGridViewByPhoneCompany()
        {
            try
            {
                List<DTCall> db = bll.GetGridViewDataByPhoneCompany(contactPhone.Text, companyName.Text);
            ...
            try
            {
                    ...
                    && String.IsNullOrEmpty(comboCityStateZip.Text) && String.IsNullOrEmpty(reasonForCall.Text) && String.IsNullOrEmpty(repEmail.Text) && String.IsNullOrEmpty(notesParagraph.Text))
                {
                    ...
                    if (contactName.Items.Count > 0)
                    {
                        ...
                        SetCompanyName();
                        SetCityStateZip();
                        PopulateDataGridViewByPhoneCompany();
                    }
        ...
        public int SaveFormToDatabase()
        {
            try
            {
                ...
                if (this.ValidateChildren() && AddressList_Validate())
                {
        ...
        private void RepEmail_Validating(object sender, CancelEventArgs e)
        {
        ...
        private void CompanyName_Validating(object sender, CancelEventArgs e)
        {

        }
        private void CompletedAnswer_Validating(object sender, CancelEventArgs e)
        {

        }
        private bool AddressList_Validate()
        {
        ...
        private void NotesParagraph_Validating(object sender, CancelEventArgs e)
        {
